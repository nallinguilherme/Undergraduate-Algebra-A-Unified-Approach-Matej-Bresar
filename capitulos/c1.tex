...
\begin{solucao}
	Vamos mostrar que $(a) \implies (b)$. Tome \(a \in \mathbb{Z}\), \newline \(T = \{-ka, \ldots, -a, 0, a, \ldots, ja\}\) para algum \(a \in \mathbb{Z} \) e \( k, j \in \mathbb{N}  \), sem perca de generalidade. Sendo assim, tome $-ka$ e $ja$ e faça $(-ka) + (ja) = (-k + j)a = (j - k)a \in T$, pois $T$ é fechado por subtração.

	Vamos mostrar $(a) \implies (c)$.
\end{solucao}